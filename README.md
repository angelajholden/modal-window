...
[![Watch the Build](https://img.shields.io/badge/YouTube-Watch-blue?logo=youtube)](https://www.youtube.com/playlist?list=PLiEcEGGtRVumXKmJ96pB18ytpBHQtyAcr)

This is a simple, clean modal dialog example built with HTML, SCSS and vanilla JavaScript. The goal of this project is to turn a static design into accessible, modern code — and make it easy for anyone to customize or learn from.
...
[project playlist](https://www.youtube.com/playlist?list=PLiEcEGGtRVumXKmJ96pB18ytpBHQtyAcr) to follow the full step-by-step process.
...
```bash
git clone git@github.com:angelajholden/modal-window.git
```
